...
import com.shopreviews.dto.ScrollResult;
import com.shopreviews.dto.UserDTO;
import com.shopreviews.entity.Blog;
import com.shopreviews.entity.Follow;
import com.shopreviews.entity.User;
import com.shopreviews.mapper.BlogMapper;
import com.shopreviews.service.IBlogService;
...
public class BlogServiceImpl extends ServiceImpl<BlogMapper, Blog> implements IBlogService {
    ...
    public Result likeBlog(Long id) {
        ...
        if (score == null) {
            ...
            //3.2.保存用户到redis 的Zset 集合 zadd key value score
            if (isSuccess) {
    ...
    public Result queryBlogLikes(Long id) {
        ...
        //3.根据用户id查询用户  WHERE id IN (1010, 1) ORDER BY FILED (ID, 1010 ,1)
