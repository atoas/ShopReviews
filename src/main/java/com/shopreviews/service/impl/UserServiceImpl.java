...
import com.shopreviews.mapper.UserMapper;
import com.shopreviews.service.IUserService;
import com.shopreviews.utils.RegexUtils;
...
import static com.shopreviews.utils.RedisConstants.*;
import static com.shopreviews.utils.SystemConstants.USER_NICK_NAME_PREFIX;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public Result signCount() {
        ...
        //4.获取今天是本月的第几天
        int dayOfMonth = now.getDayOfMonth();
        //5.获取本月截止到今天为止的所有签到记录，返回的是一个十进制的数字 BITFIELD sign:1:202205 GET u14 0
